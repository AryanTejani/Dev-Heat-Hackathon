...
import { PlusIcon, RefreshCw, Users, MessageSquare } from "lucide-react";
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {projects.map((project) => (
              <div
                ...
                className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer overflow-hidden border border-gray-100 hover:border-indigo-100 h-48 flex flex-col"
              >
